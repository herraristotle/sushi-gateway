    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "API Key Authentication", link: "/plugins/key-auth" },
          { text: "Mutual TLS (mTLS)", link: "/plugins/mtls" },
          { text: "Multi-Auth (OR Logic)", link: "/plugins/multi-auth" },
          { text: "WAF (Coraza + CRS)", link: "/plugins/waf" },
          { text: "Bot Protection", link: "/plugins/bot-protection" },
          { text: "Access Control List (ACL)", link: "/plugins/acl" },
          { text: "RBAC (Role-Based)", link: "/plugins/rbac" },
          { text: "Rate Limiting", link: "/plugins/rate-limit" },
          { text: "Circuit Breaker", link: "/plugins/circuit-breaker" },
          { text: "Request Size Limit", link: "/plugins/request-size-limit" },
          { text: "Response Cache", link: "/plugins/cache" },
          { text: "CORS", link: "/plugins/cors" },
          { text: "Header Transformation", link: "/plugins/header-transformation" },
          { text: "Shadow Traffic", link: "/plugins/shadow-traffic" },
          { text: "Prometheus Metrics", link: "/plugins/prometheus" },
          { text: "OpenTelemetry Tracing", link: "/plugins/opentelemetry" },
          { text: "HTTP Logging", link: "/plugins/http-log" },
        ],
      },
      {
        text: "Operations",
        ...
        items: [
          ...
          { text: "Zero-Downtime Upgrades", link: "/operations/zero-downtime-upgrades" },
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Debug Logging", link: "/troubleshooting/debug-logging" },
          { text: "Gateway FAQ", link: "/troubleshooting/faq" },
        ],
      },
      {
        text: "Admin REST API",
